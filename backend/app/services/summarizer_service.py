...
from app.core.config import PDF_SMART_THRESHOLD
...
# Local summarizer models - Recommended: casecut-legal (fine-tuned T5 for legal text)
# Better performance on legal documents compared to generic models
LOCAL_SUMMARIZER_MODELS = {
    "casecut-legal": BACKEND_ROOT / "Model" / "fine_tuned_t5_summarizer",  # Recommended for legal summarization
    ...
    "local-legal-bart": BACKEND_ROOT / "Model" / "legal-summarizer-bart",  # Good alternative for legal text
